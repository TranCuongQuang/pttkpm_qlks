                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" placeholder="Từ ngày" class="form-control" readonly="readonly" ng-model="txtFromDate" />
                        </div>
                        <div class="form-group col-md-6">
                            <label class="control-label">Đến ngày</label>
                            <input type="text" placeholder="Đến ngày" class="form-control" readonly="readonly" ng-model="txtToDate" />
                        </div>
                        <div class="form-group col-md-6">
